...
class MyApp(App):
    def build(self):
        ...
        # Create and add the remaining buttons to the layout
        for i in range(2):  # Adjusted range since we're adding one less button
            button = Button(text=f'Button {i+2}')  # Adjusted button text to start from 2
